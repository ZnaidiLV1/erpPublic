...
class RevenueSettingsPanel extends StatefulWidget {
  final Function()? onClose;
  final Function()? onSave;
  final Function()? onCancel;
  final RevenueModel revenue;

  const RevenueSettingsPanel({
    Key? key,
    this.onClose,
    this.onSave,
    this.onCancel, required this.revenue,
  }) : super(key: key);

  @override
  State<RevenueSettingsPanel> createState() => _RevenueSettingsPanelState();
}

class _RevenueSettingsPanelState extends State<RevenueSettingsPanel> {
  ...
  void initState() {
    _dateController = TextEditingController(text: widget.revenue.date);
    _categoryController = TextEditingController(text: widget.revenue.category);
    _subCategoryController =
        TextEditingController(text: widget.revenue.subCategory);
    _detailsController = TextEditingController(
        text: widget.revenue.details);
    _amountController = TextEditingController(text: widget.revenue.ammount);
    _timeController = TextEditingController(text: widget.revenue.time);
    category = widget.revenue.category;
    subCategory = widget.revenue.subCategory;
    super.initState();
  }
                      ...
                      _buildButton(
                        ...
                        onPressed: (){
                          if (category == null ||
                            ...
                            getIt<RevenueService>().updateRevenue(revenue.toJson());
                          }
                          widget.onSave!();
                        },
                      ),
