...
class AddDepense extends StatefulWidget {
  ...
  const AddDepense({super.key, required this.onCancelPressed});

  @override
  _AddDepenseState createState() => _AddDepenseState();
}
                ...
                ElevatedButton(
                  onPressed: () {
                    if (category == null ||
                      ...
                      getIt<ExpenseService>().addExpense(expense.toJson());
                      showSuccessDialog(context, "Dépense ajoutée !");
                      _clearForm();
                    }
                  },
                  style: ElevatedButton.styleFrom(
